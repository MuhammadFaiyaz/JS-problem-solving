...
/**
 * নাম দিয়ে export হলো যখন আমরা ফাইল থেকে একাধিক জিনিস এক্সপোর্ট করি, এবং প্রতিটির নির্দিষ্ট নাম থাকে। import করার সময় সেই নামই ব্যবহার করতে হয়, এবং {} ব্যবহার করতে হয়। ইচ্ছামতো নাম দিলে Error হয়।  Default Export হলো পুরো ফাইল থেকে একটা নির্দিষ্ট জিনিস default হিসেবে এক্সপোর্ট করা হয়। তখন ইম্পোর্ট করার সময় ইচ্ছামতো নাম ব্যবহার করা যায়, {} দরকার হয় না। এক ফাইলে একসাথে named export আর default export দুইটাই রাখা যায়।
 */
